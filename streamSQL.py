...
def connect(username, created_at, tweet, retweet_count, place, location):
    ...
    try:
        con = mysql.connector.connect(host='localhost',
                                      database='twitterdb', user='root', password=password, charset='utf8', auth_plugin='mysql_native_password')
        ...
        if con.is_connected():
            ...
            cursor = con.cursor()
            # twitter, golf
            query = "INSERT INTO twitterdb.golf (username, created_at, tweet, retweet_count,place, location) VALUES (%s, %s, %s, %s, %s, %s)"
